...
this._swal.callSwall("Ürünü silmek istiyor musunuz?","Ürünü Sil","Sil",()=>{
  let model={_id:_id};
...
changeProductStatus(_id:string){
  this._swal.callSwall("Ürünün durumunu değiştirmek istiyor musunuz?","Durumu Değiştir","Değiştir",()=>{
    let model={_id:_id};
